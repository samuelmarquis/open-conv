...
| 4 | **Wet Sat** | mix | 0.00×–4.00× (1.00×) | tanh drive on the summed wet. 0 = fully linear; 1 = gentle safety (transparent below ≈ −12 dBFS); higher = deliberate sub saturation. The resonant banks (Subdrop/Resoroom) lean on this — coherent low-end buildup lands as saturation instead of overload. |
